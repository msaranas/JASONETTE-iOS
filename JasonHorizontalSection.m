...
- (UICollectionViewCell*)getItemCell:(NSDictionary *)item forCollectionView:(UICollectionView *)collectionView atIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.layer.cornerRadius = 1; // if you like rounded corners
    cell.layer.shadowOffset = CGSizeMake(-.2f, .2f); //%%% this shadow will hang slightly down and to the right
    cell.layer.shadowRadius = 1; //%%% I prefer thinner, subtler shadows, but you can play with this
    cell.layer.shadowOpacity = 0.2; //%%% same thing with this, subtle is better for me
